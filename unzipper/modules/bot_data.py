...
By default, videos uses a thumbnail generated by `ffmpeg` and files doesn't have one. If you want to set-up
your own thumbnail, you can do so using following commands 👇,
